...
| date | memo | status |
|---|---|---|
| 2026-09-22 | [Browser workspace](prototypes/README.md) — desktop preview and connected saved viewer | Verified read-only notebook replay; live controls deferred, no new research result |
