...
- `config.json` — the pins: snapshot ID, ChatSight SHA, schema version ID, classifier
  prompt/config hash, model IDs. An experiment without complete pins is invalid (CLAUDE.md
